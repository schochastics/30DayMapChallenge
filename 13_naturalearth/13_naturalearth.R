...
p <- ggplot()+
  ...
  geom_sf_text(data=europe[europe$pop_est>8e6 & !europe$name_long%in%c("Netherlands","Belgium","Portugal"),],
  ...
  #caption
  annotate("richtext",x=Inf,y=-Inf,hjust=1,vjust=0,label="<span style='font-size:22pt'>@schochastics</span>",
